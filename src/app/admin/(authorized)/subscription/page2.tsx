...
export default function SubscriptionPage() {
  ...
  return isFetchingSubscription ? (
    ...
    <div className="p-6 custom-64 h-full bg-gradient-to-br from-black via-black to-violet-950">
      <div className="max-w-7xl mx-auto w-full h-full">
        <div className={`flex ${subscriptions.length<3?"justify-between":"justify-center"} items-center mb-8 px-16`}>
