            ...
            <div className="max-w-lg mx-auto space-y-6">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">GST({PaymentConfig.GST_RATE*10}%)</span>
                    <span className="font-medium">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-2xl hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-[1.02] active:scale-[0.98] font-medium shadow-lg shadow-blue-200/50"
              >
                {paymentLoading ? (
