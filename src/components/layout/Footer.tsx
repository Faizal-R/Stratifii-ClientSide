          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold text-violet-200">Stratifii Interviews</span>
              </div>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4 text-violet-200 hover:text-white transition">Product</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4 text-violet-200 hover:text-white transition">Company</h4>
              <ul className="space-y-2">
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4 text-violet-200 hover:text-white transition">Support</h4>
              <ul className="space-y-2">
