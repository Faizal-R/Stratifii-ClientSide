...
const Sidebar: React.FC<SidebarProps> = ({ navItems, handleModalState }) => {
 ...
 const {isSidebarCollapsed,toggleSidebarCollapse}=useSidebarCollapseStore()
    ...
    >
      <div className="p-4 border-b border-gray-800 flex items-center justify-between">
        ...
        <button
          ...
          className="hidden  md:block p-2 hover:bg-gray-800 rounded-lg transition-colors border border-violet-900 text-white"
        >
          {isSidebarCollapsed ? (
